...
class Blockchain:
    ...
    def add_block(self, block):
        ...
        # Check if previous_hash stored in the block is equal to the local blockchain's
        # last block's hash and store the result in a block
        ...
        converted_block = Block(
            block['index'],
            block['previous_hash'], transactions,
            block['proof'],
            block['timestamp'])
